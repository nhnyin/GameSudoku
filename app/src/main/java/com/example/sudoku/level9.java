...
public class level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewfake);
        ...
        button_proverka.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(p1==4&&p2==6&&p3==2&&p4==10&&p5==8&&
                    ...
                    if(level>9){}else {SharedPreferences.Editor editor=save.edit();
